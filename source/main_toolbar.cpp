...
MainToolBar::MainToolBar(wxWindow* parent, wxAuiManager* manager)
{
	...
	wxBitmap worldgen_bitmap = wxArtProvider::GetBitmap(wxART_NEW, wxART_TOOLBAR, icon_size);
	standard_toolbar->AddSeparator();
	standard_toolbar->AddTool(TOOLBAR_WORLDGENERATOR, "WorldGen", worldgen_bitmap, wxNullBitmap, wxITEM_NORMAL, "Generate a new map", wxEmptyString, NULL);
	...
	Bind(wxEVT_TOOL, &MainFrame::OnWorldGenerator, this, TOOLBAR_WORLDGENERATOR);
